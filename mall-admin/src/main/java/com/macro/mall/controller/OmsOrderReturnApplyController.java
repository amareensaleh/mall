...
public class OmsOrderReturnApplyController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<OmsOrderReturnApply>> listOmsOrderReturnApply(OmsReturnApplyQueryParam queryParam,
    ...
    @ResponseBody
    public CommonResult<Integer> deleteReturnApplies(@RequestParam("ids") List<Long> ids) {
    ...
    @ResponseBody
    public CommonResult<OmsOrderReturnApplyResult> getItemOmsOrderReturnApplyResult(@PathVariable Long id) {
