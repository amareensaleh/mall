...
public class SmsFlashPromotionProductRelationController {
    ...
    @ResponseBody
    public CommonResult<Integer> createSmsFlashPromotionProductRelations(@RequestBody List<SmsFlashPromotionProductRelation> relationList) {
    ...
    @ResponseBody
    public CommonResult<Integer> updateSmsFlashPromotionProductRelation(@PathVariable Long id, @RequestBody SmsFlashPromotionProductRelation relation) {
    ...
    @ResponseBody
    public CommonResult<SmsFlashPromotionProductRelation> getItemSmsFlashPromotionProductRelation(@PathVariable Long id) {
    ...
    @ResponseBody
    public CommonResult<CommonPage<SmsFlashPromotionProduct>> listSmsFlashPromotionProduct(@RequestParam(value = "flashPromotionId") Long flashPromotionId,
