...
public class SmsHomeBrandController {
    ...
    @ResponseBody
    public CommonResult<Integer> createSmsHomeBrands(@RequestBody List<SmsHomeBrand> homeBrandList) {
    ...
    @ResponseBody
    public CommonResult<Integer> deleteHomeBrands(@RequestParam("ids") List<Long> ids) {
    ...
    @ResponseBody
    public CommonResult<Integer> updateRecommendStatusHomeBrand(@RequestParam("ids") List<Long> ids, @RequestParam Integer recommendStatus) {
    ...
    @ResponseBody
    public CommonResult<CommonPage<SmsHomeBrand>> listSmsHomeBrand(@RequestParam(value = "brandName", required = false) String brandName,
