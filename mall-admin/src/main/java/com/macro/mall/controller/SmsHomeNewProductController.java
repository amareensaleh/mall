...
public class SmsHomeNewProductController {
    ...
    @ResponseBody
    public CommonResult<Integer> createSmsHomeNewProducts(@RequestBody List<SmsHomeNewProduct> homeNewProductList) {
    ...
    @ResponseBody
    public CommonResult<Integer> updateSortNewProduct(@PathVariable Long id, Integer sort) {
    ...
    @ResponseBody
    public CommonResult<Integer> deleteNewProducts(@RequestParam("ids") List<Long> ids) {
    ...
    @ResponseBody
    public CommonResult<CommonPage<SmsHomeNewProduct>> listSmsHomeNewProduct(@RequestParam(value = "productName", required = false) String productName,
