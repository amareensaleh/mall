...
public class SmsHomeRecommendSubjectController {
    ...
    @ResponseBody
    public CommonResult<Integer> createSmsHomeRecommendSubjects(@RequestBody List<SmsHomeRecommendSubject> homeRecommendSubjectList) {
    ...
    @ResponseBody
    public CommonResult<Integer> updateSortRecommendSubject(@PathVariable Long id, Integer sort) {
    ...
    @ResponseBody
    public CommonResult<Integer> deleteRecommendSubjects(@RequestParam("ids") List<Long> ids) {
    ...
    @ResponseBody
    public CommonResult<Integer> updateRecommendStatusRecommendSubject(@RequestParam("ids") List<Long> ids, @RequestParam Integer recommendStatus) {
